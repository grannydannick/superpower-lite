...
export const AdvancedPanelUpgradeControl = ({
  variant,
}: {
  variant: string;
}) => {
          ...
          <div className="flex flex-1 flex-col md:w-1/2 md:p-8">
            ...
            <div className="hidden space-y-1 px-0 md:block">
              ...
              <p className="text-sm text-zinc-500">
                ...
                your Baseline panel. Go deeper and broader across cardiovascular
                risk, hormones, metabolic health, inflammation, and kidney
                function.
              </p>
            </div>
            ...
            <div className="hidden space-y-8 py-6 md:block">
              ...
              <OrderButtons price={priceInCents} variant={variant} />
            </div>
