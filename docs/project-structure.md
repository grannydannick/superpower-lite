...
|
+-- api         # exported API request declarations and api hooks related to a specific feature (should always include index.ts)
|
...
|
+-- const       # const variables for a specific feature
```
