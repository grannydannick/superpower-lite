...
const RX_TIRZEPATIDE_MICRODOSE = 'rx-assessment-tirzepatide-microdose';
const RX_TIRZEPATIDE_MICRODOSE_SYMPTOM_TRACKER =
  'rx-assessment-tirzepatide-microdose-symptom-tracker';
...
const RX_SYMPTOM_TRACKERS = [
  ...
  RX_TIRZEPATIDE_MICRODOSE_SYMPTOM_TRACKER,
] as const;
...
type RxQuestionnaireName =
  ...
  | typeof RX_TIRZEPATIDE_MICRODOSE
  | typeof RX_TIRZEPATIDE_MICRODOSE_SYMPTOM_TRACKER;
