    ...
    <div className="mx-auto w-full max-w-[800px] space-y-8 p-6 pb-24 lg:px-16">
      ...
      <div className="flex flex-col gap-2 rounded-2xl border border-zinc-200 p-4">
        <div className="flex items-center gap-2">
          ...
          <Body2 className="text-vermillion-900">About this Protocol</Body2>
        </div>
        <Body1 className="text-zinc-400">
          Your Protocol is generated by Superpower&rsquo;s AI using your unique
          medical data. Superpower isn&rsquo;t a replacement for your primary
          care provider. Questions or concerns? Review these results with your
          doctor.
        </Body1>
      </div>
