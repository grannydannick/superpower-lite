...
It's best practice to measure IgE and IgG antibodies together as they independently create inflammation and play a role in symptoms driven by food. A food can elicit an IgE sensitivity response, an IgG antibody response, or both.`,
      'Pre-test considerations': `* Hydrate the day prior to sample collection.
* Drink water 30 minutes before you draw your blood.
* Continue taking any nutritional supplements and medications unless advised differently by your healthcare provider.`,
    },
...
4. Do not drink more than 8 oz water 1 hour prior to urine collection.`,
    ...
    'Intestinal Permeability Panel': {
      "What's measured?": `The following key markers can be found within the Wheat Zoomer tests:
...
3. Receive your results within two weeks. 
4. Schedule a consultation with your longevity advisor team to review your results and create an action plan.`,
      'Pre-test considerations': `1. If you are currently taking (or have recently taken) any of the following medications, consult your healthcare provider regarding the timing of collection.
  * Steroids
...
4. Schedule a consultation with your care team to review your results and create an action plan.`,
      'Why is this test important?': `Testing for PFAS chemicals in your blood is important because:
...
4. Do not drink more than 8 oz water 1 hour prior to urine collection.`,
    ...
    'Continuous Glucose Monitor': {
      ...
      'Test process': `1. Order your CGM -- we'll deliver it directly to your house in 3-5 days.
