...
export const LocationList = ({
  ...
  return (
    <div className="overflow-hidden rounded-2xl border border-zinc-200 bg-white p-1">
      <div className="max-h-[320px] overflow-y-auto scrollbar scrollbar-thumb-zinc-300 [overflow:overlay] [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar]:w-2">
        <RadioGroup
