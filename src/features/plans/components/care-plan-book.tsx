    ...
    >
      ...
      <div className="relative size-full">
        ...
        >
          ...
          <div className="absolute z-10 flex size-full flex-col py-2 pl-4 pr-12">
            <Body1 className="flex-1 leading-tight text-white">{title}</Body1>
            <Body4 className="text-white">{date}</Body4>
          </div>
          <img
        ...
        <div
          className={cn(
            'absolute flex flex-col px-5 pt-4 pb-2 left-0 top-1 h-[calc(100%-8px)] w-[calc(100%-8px)] z-30 bg-gradient-to-r from-zinc-300 via-white via-50% to-white rounded-lg',
            'origin-left transform-gpu [backface-visibility:hidden]',
            'transition-all duration-500 ease-out will-change-transform',
