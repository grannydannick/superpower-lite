...
import { editorAtomicStore } from '../utils/store';
...
export const EditorCommandOut: FC<EditorCommandOutProps> = ({
  ...
  const setQuery = useSetAtom(queryAtom, { store: editorAtomicStore });
  const setRange = useSetAtom(rangeAtom, { store: editorAtomicStore });
