...
import {
  END_TYPE_KEY,
  STEP_TYPE_KEY,
} from '@/features/questionnaire/core/constants';
import {
  calculateNumberOfSteps,
  enhanceStep,
} from '@/features/questionnaire/core/index.core';
import { QuestionnaireContext } from '@/features/questionnaire/core/services/questionnaire-context';
...
export const Questionnaire = ({ initialStep, finished, children }: Props) => {
  ...
  const elements = React.Children.map(children, (child: JSX.Element) => {
    ...
    // Maybe related to {questionnaireComplete && (<component></component>)} expressions
